...
<br><br>
<div class="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-3xl shadow-md dark:bg-gray-700">
    <div class="px-6 py-4">
        <div class="flex justify-center mx-auto">
            <img class="w-auto h-7 sm:h-8" src="../images/logo.png" alt="">
        </div>

        <h3 class="mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200">Registrasi</h3>

        <p class="mt-1 text-center text-gray-500 dark:text-gray-400">-</p>

        <form>
            <div class="w-full mt-4">
                <input class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="username" placeholder="Username" aria-label="Username" />
            </div>
