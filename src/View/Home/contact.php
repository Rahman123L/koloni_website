...
<section class="bg-white dark:bg-gray-800">
    <div class="container px-6 py-12 mx-auto">
        <div>
            <p class="text-3xl font-medium text-blue-500 dark:text-blue-400">Contact Us</p>

            <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">-</h1>
