...
<section class="bg-white dark:bg-gray-800">
    <div class="container px-6 py-12 mx-auto">
        <div class="text-center">
            <h1 class="text-3xl font-medium text-blue-500 dark:text-blue-400">Contact us</h1>

            <h2 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">-</h2>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <p class="mt-2 text-blue-500 dark:text-blue-400">-</p>
            </div>
