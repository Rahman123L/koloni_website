...
<section class="bg-white dark:bg-gray-800">
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Gallery
        </h1>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
                ...
                <div
                    ...
                    <h2 class="mt-4 text-xl font-semibold text-white capitalize">-</h2>
                    <p class="mt-2 text-lg tracking-wider text-blue-400 uppercase ">-</p>
                </div>
            </div>
